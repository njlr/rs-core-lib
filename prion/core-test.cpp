...
namespace {
    ...
    void check_arithmetic_literals() {
        ...
        TEST_NEAR_EPSILON(1.2345_a, 1.2345e-18, 1e-24);
        TEST_NEAR_EPSILON(1.2345_f, 1.2345e-15, 1e-21);
        TEST_NEAR_EPSILON(1.2345_p, 1.2345e-12, 1e-18);
        TEST_NEAR_EPSILON(1.2345_n, 1.2345e-9, 1e-15);
        TEST_NEAR_EPSILON(1.2345_u, 1.2345e-6, 1e-12);
        TEST_NEAR_EPSILON(1.2345_m, 1.2345e-3, 1e-9);
        TEST_NEAR_EPSILON(1.2345_k, 1.2345e3, 1e-3);
        TEST_NEAR_EPSILON(1.2345_M, 1.2345e6, 1);
        TEST_NEAR_EPSILON(1.2345_G, 1.2345e9, 1e3);
        TEST_NEAR_EPSILON(1.2345_T, 1.2345e12, 1e6);
        TEST_NEAR_EPSILON(1.2345_P, 1.2345e15, 1e9);
        TEST_NEAR_EPSILON(1.2345_E, 1.2345e18, 1e12);
        TEST_NEAR_EPSILON(1.2345_Z, 1.2345e21, 1e15);
        TEST_NEAR_EPSILON(1.2345_Y, 1.2345e24, 1e18);
